...
def test_tdm_fmcw_rx():
    ...
    assert np.array_equal(tdm.az_angles, [
                          ...
                          np.arange(-90, 91, 180),
                          np.arange(-90, 91, 180)])
    assert np.array_equal(tdm.az_patterns, [np.zeros(2),
                                            np.zeros(2),
                                            np.zeros(2),
                                            np.zeros(2),
                                            np.zeros(2),
    ...
    assert np.array_equal(tdm.el_angles, [
        ...
        np.arange(-90, 91, 180),
        np.arange(-90, 91, 180)])
    assert np.array_equal(tdm.el_patterns, [np.zeros(2),
                                            np.zeros(2),
                                            np.zeros(2),
                                            np.zeros(2),
                                            np.zeros(2),

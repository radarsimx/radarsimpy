...
MACROS = [('NPY_NO_DEPRECATED_API', 'NPY_1_7_API_VERSION'),
          ('_CUDA_', None)]
INCLUDE_DIRS = ['src/radarsimc/includes',
                'src/radarsimc/includes/zpvector']
...
ext_modules = [
    Extension('radarsimpy.radar',
              ['src/radarsimpy/radar.py'],
              define_macros=MACROS),
    Extension('radarsimpy.util',
              ['src/radarsimpy/util.py'],
              define_macros=MACROS),
    Extension('radarsimpy.processing',
              ['src/radarsimpy/processing.py'],
              define_macros=MACROS),
    Extension('radarsimpy.tools',
              ['src/radarsimpy/tools.py'],
              define_macros=MACROS),
    Extension('radarsimpy.lib.cp_radarsimc',
    ...
    Extension('radarsimpy.rt',
              ...
              library_dirs=LIBRARY_DIRS+[CUDA['lib64']],
              extra_link_args=LINK_ARGS),
    Extension('radarsimpy.simulator',
              ['src/simulator.pyx'],
              define_macros=MACROS,
              include_dirs=INCLUDE_DIRS+[CUDA['include']],
              libraries=['radarsimc'],

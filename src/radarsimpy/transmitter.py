...
class Transmitter:
    ...
    :param prp: Pulse repetition period (PRP) in seconds (s).
    ...
    :param numpy.ndarray f_offset: Frequency offset for each pulse in Hertz (Hz).
        The length must match ``pulses``.
